...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.68\textwidth]{figures/model_comparison.pdf}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.60\textwidth]{figures/roc_curves.pdf}
