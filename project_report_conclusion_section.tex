...
All training was done using publicly available cloud compute (Kaggle's free GPU tier), and the three base models were built on top of existing pretrained weights rather than trained from scratch. This kept energy consumption significantly lower than it would have been for a full from-scratch training run.
\end{spacing}
